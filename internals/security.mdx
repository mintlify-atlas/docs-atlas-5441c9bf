...
description: "Kopia Desk security layers: context isolation, safePath traversal checks, 50 MB manifest cap, journal crash recovery, and source-name collision prevention."
---
