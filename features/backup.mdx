---
title: "Incremental Backup: Scan, Diff, and Copy"
sidebarTitle: "Backup"
description: "How Kopia Desk scans source folders, compares against the saved manifest, and copies only new and changed files to the destination drive with adaptive concurrency."
---
...
This lets you recover the file as it was before the most recent backup. Versions are stored by ISO timestamp so multiple versioned runs accumulate in separate subdirectories.
