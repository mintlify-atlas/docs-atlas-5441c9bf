---
title: "Path Safety Utilities: safeName, safePath, and More"
sidebarTitle: "Path Safety"
description: "lib/core.js exports safeName and safePath to sanitise file names and block path traversal attacks before any byte is written to the backup drive."
---
...
These functions are documented in detail in the [Drives and Folders API reference](/api/drives-and-folders).
