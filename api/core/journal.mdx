---
title: "Operation Journal: Crash Detection and Cleanup"
sidebarTitle: "Journal"
description: "lib/core.js journal functions track backup operations in append-only JSONL files, detect interrupted copies, and safely clean up partial files on the next run."
---
...
<Steps>
  ...
  <Step title="Append per file">
    After each successful `fs.copyFileSync`, `appendJournalDone(journalPath, relativeDest)`
...
const journalPath = startJournal(
  ...
  [
    { relativeDest: 'Fotos\\img1.jpg' },
    { relativeDest: 'Fotos\\img2.jpg' },
  ]
);
...
appendJournalDone(journalPath, 'Fotos\\img1.jpg');
```
